...
export function CycleSummary() {
  ...
  return (
    <div className="mb-5 grid gap-4 sm:grid-cols-2 xl:grid-cols-5">
      ...
      <MetricCard label="Erros recentes" value={isLoading ? '...' : data?.processosErro || 0} hint="Verifique a pagina de processos">
        <AlertTriangle className="text-rose-300" size={22} />
      </MetricCard>
      <MetricCard label="Ultimo ciclo" value={<span className="text-lg">{formatDateTime(data?.ultimoCicloFim)}</span>} hint="Data do ultimo processo finalizado">
